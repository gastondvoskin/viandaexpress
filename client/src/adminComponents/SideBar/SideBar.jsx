    ...
    return (
        <div className={style.sidebar}>
            <ul>
                <li>
                <div
                    className={style.option + (sidebarOption === 'dashboard' ? ' ' + style.activeOption : '')}
                ...
                <li>
                <div
                    className={style.option + (sidebarOption === 'products' ? ' ' + style.activeOption : '')}
                ...
                <li>
                <div
                    className={style.option + (sidebarOption === 'orders' ? ' ' + style.activeOption : '')}
                ...
                <li>
                <div
                    className={style.option + (sidebarOption === 'reviews' ? ' ' + style.activeOption : '')}
                ...
                <li>
                <div
                    className={style.option + (sidebarOption === 'users' ? ' ' + style.activeOption : '')}
