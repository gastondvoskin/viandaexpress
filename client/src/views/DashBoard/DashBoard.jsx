            ...
            <div className={style.SubSectionDB}>
              <div className={style.SectionDB}>
                <div className={style.NumberDB}>
                  ...
                  />
                  {errors.initial_price ? <p>{errors.initial_price}</p> : null}
                </div>
                <div className={style.NumberDB}>
                  <label>
                    <h3>Descuento de Vianda:</h3>
                  </label>
                  <input
                    type="number"
                    name="discount"
                    ...
                    className={style.InputNumberDB}
                  />
                  {errors.discount ? <p>{errors.discount}</p> : null}
                </div>
              </div>
              <div>
                <label>
                ...
                <label>
                  podemos implementar cloudinary, sino usamos un input text
                </label>
                <input type="file" name="image" onChange={handleImageChange} />
                {errors.image ? <p>{errors.image}</p> : null}
              </div>
              <button type="submit" className={style.ButtonDB}>
                Crear Vianda
              </button>
            </div>
          </div>
